...
static void compute_roots(double* x13, double* x23, double* x12)
{
    *x13 = root(f1, f3, X13_A, X13_B, EPS1);
    *x23 = root(f2, f3, X23_A, X23_B, EPS1);
    *x12 = root(f1, f2, X12_A, X12_B, EPS1);
}

/* Compute iteration counts for all three root searches. */
...
int main(int argc, char** argv)
{
    ...
    {
        int i13, i23, i12;
        compute_iterations(&i13, &i23, &i12);
